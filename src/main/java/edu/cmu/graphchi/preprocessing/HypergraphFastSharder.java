...
public class HypergraphFastSharder <VertexValueType, List<EdgeValueType> > {
     ...
     */
    public HypergraphFastSharder(String baseFilename, int numShards,
    ...
    public static void main(String[] args) throws Exception {
        ...
        HypergraphFastSharder<Integer, Integer> sharder = new HypergraphFastSharder<Integer, Integer>(fileName, numShards, null, new EdgeProcessor<Integer>() {
            @Override
