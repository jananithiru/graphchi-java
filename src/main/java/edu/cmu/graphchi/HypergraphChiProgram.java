 ...
 * @param <EdgeDataType>
 */
public interface HypergraphChiProgram <VertexDataType, EdgeDataType> {
     ...
     */
    public void updateVertex(ChiVertex<VertexDataType, EdgeDataType> vertex, GraphChiContext context);

    public void updateHyperedge(ChiVertex<VertexDataType, EdgeDataType> vertex, GraphChiContext context);
